    ...
    return (
      ...
      <div className="min-h-screen bg-white flex flex-col">
        ...
        <main className="flex-grow  pt-6  pb-10 ">
          ...
          <div className="mx-auto grid max-w-6xl grid-cols-1 gap-6 lg:grid-cols-[1fr_300px] p-6">
            ...
            <div className="rounded-lg border border-gray-200 p-5">
              ...
              <div className="border-t border-gray-200">
                ...
                {cartItems.map((item) => (
                  <div
                    key={item.id}
                    className="flex items-start gap-4 border-b border-gray-200 py-5"
                  >
              ...
              {/* Notes */}
              <div className="space-y-3 border-b border-gray-200 py-5 text-sm text-gray-600">
